...
namespace client_wf2
{
    public partial class Form1 : Form
    {
        ...
        private async void button2_Click(object sender, EventArgs e)
        {
            ...
            //Создаем объект класса Msg_t 
            Msg_t msg_t = new Msg_t("name", msg);

            //Сериализуем объект msg_t в json строку   ->    {"Command":"name","Text":"$textBox1.Text$"}
        ...
        async Task receive_(Socket socket)
        {
            try
            {
                while (true)
                {
                    ...
                    //Десериализации json строку в объект msg_t /  {"Command":"name","Text":"$textBox1.Text$"} to  Msg_t("Command", "Text")
